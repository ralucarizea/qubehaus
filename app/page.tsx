...
const carouselItems: { index: string; bgImagePath: string; description: string }[] = [
    ...
    {index: '1', bgImagePath: '/carousel-housesaside-min.jpg', description: 'blablabla'},
    {index: '2', bgImagePath: '/carousel-house2-min.jpg', description: 'dadada'},
    {index: '3', bgImagePath: '/carousel-house3-min.jpg', description: 'mamamama'},
]

const LandingPage: React.FC<MyType> = () => {
    return (
        <>
            <div className='w-full h-[130vh] bg-yellow-100 absolute  z-[-2] top-0  bg-no-repeat bg-cover bg-top'
                 style={{backgroundImage: `url('/beachhouses-min.jpg')`}}>
            </div>
            <div className='bg-transparent'>
                <section
                    className='flex flex-col h-[100vh] justify-start items-center w-full text-primary relative bg-transparent'>
                    <div
                        className='flex items-start justify-center w-full text-[350px] font-extralight tracking-[-36px] mr-16'>
                        XL10
                    </div>
                ...
                <section
                    ...
                    <div className='text-[110px] tracking-[-4px]'>
                        <div>Backyard <div
                            className='inline-block mx-4 w-[250px] h-[100px] bg-green-100 rounded-xl mb-[-16px]'>
                            {/*    <Image*/}
                        ...
                        <div className='mt-[-40px] '>customizable,
                            <div
                                className='inline-block bg-blue-100 mx-4 w-[210px] h-[100px] rounded-xl mb-[-16px]'>{/*    <Image*/}
                                {/*    className='inline-block mx-2'*/}
                                {/*    alt=''*/}
                        ...
                        <div className='mt-[-40px]'>ADU <div
                            className='inline-block mx-4 mb-[-16px] w-[280px] h-[100px] bg-orange-100 rounded-xl'>
                            {/*    <Image*/}
                            {/*    className='inline-block mx-2'*/}
                            {/*    alt=''*/}
                    ...
                    <Carousel className="w-full max-w-full" opts={{
                        ...
                        <CarouselContent className="-ml-1">
                            {carouselItems.map(item =>
                                <CarouselItem key={item.index} className="pl-1 md:basis-1/2 lg:basis-2/3">
                                    <div className="p-4">
                ...
                <section className='bg-background'>
                    <div
                        className='flex flex-col w-full items-center justify-center text-[60px] text-primary py-[10%] font-extralight tracking-[-4px]'>
                        <div>
                ...
                <section className='bg-background flex w-full items-center justify-center gap-28 h-[85vh] py-32'>
                    <Card className='w-2/5 h-full bg-orange-50 rounded-[16px] border-none shadow-md'>
                        <CardTitle className='pl-8 pt-8 font-extralight flex flex-col text-h3 gap-2'> Experience
                            QubeHaus in
                    ...
                    <Card className='w-2/5 h-full bg-orange-50 rounded-[16px] border-none shadow-md'>
                        <CardTitle className='pl-8 pt-8 font-extralight flex flex-col text-h3 gap-2'> Learn how we
                            squeeze a
                            whole house into your yard.
                            <Button variant='link'
                                    className='p-0 text-[30px] font-light flex gap-2 items-center justify-start'> How it
                                works <MoveRight/></Button>
                        </CardTitle>
                    </Card>
                </section>
                <section
                    className='bg-background flex flex-col w-full gap-40 min-h-fit justify-between h-[170vh] justify-center items-center py-[16rem]'>
                    <div className='h-1/2 w-full flex gap-5 justify-center'>
                        ...
                        <Card
                            ...
                            <CardContent className='w-full p-0 pt-3 flex flex-col gap-5'>
                                ...
                                <CardDescription
                                    className='font-light text-[18px] max-w-[75%] leading-5 tracking-tight'>
                                    Tailor your unit with a layout and customizations that reflect your style and needs.
                                </CardDescription>
                                <div className='bg-gray-100 rounded-lg w-[450px] max-w-[80%] h-[500px]'>
                        ...
                        <Card
                            ...
                            <CardContent className='w-full p-0 pt-3 flex flex-col gap-5'>
                                ...
                                <CardDescription
                                    className='font-light text-[18px] max-w-[80%] leading-5 tracking-tight'>
                    ...
                    <div className='h-1/2 w-full flex gap-5 justify-center ml-[-76px]'>
                        ...
                        <Card
                            ...
                            <CardContent className='w-full p-0 pt-3 flex flex-col gap-5'>
                                <CardTitle className='font-extralight text-h3'> Sign off </CardTitle>
                                <CardDescription
                                    className='font-light text-[18px] max-w-[85%] leading-5 tracking-tight'>
                                    We visit your site to create a complete proposal for the work required to install
                                    Backyard.
                                </CardDescription>
